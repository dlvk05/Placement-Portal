...
import styles from "./AdminEligibilityCriteriaComponent.module.css";

const AdminEligibilityCriteriaComponent = (props) => {
...
export default AdminEligibilityCriteriaComponent;
